...
**Contract bundle `r10+89c349f8073d`.** 34 codes.
...
### `WILDCARD001` — Invalid, undefined, mixed, or inconsistent capture

*error, once per rule.*

- Invalid, undefined, mixed, or inconsistent wildcard capture outside a reference
